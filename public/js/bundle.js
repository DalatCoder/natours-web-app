...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGFsYXRjb2RlciIsImEiOiJjazZpcnNoYzgwM3hkM21wam8ya3RiejRjIn0.1iQ0Lpe1ouWKVq05oqz9Dg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/dalatcoder/ck6isewzt080c1ip1p15ywr6x',
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              (0, _alert.showAlert)('success', 'Your reset token has been sent to your email! Please check mail to reset your password');
            }
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee4(token, newPass, newPassConfirm) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              (0, _alert.showAlert)('success', 'Reset password successfully!');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1000);
            }
...
exports.updateUserPassword = exports.updateUserIdentification = void 0;
...
function () {
  ...
  return function updateUserIdentification(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateUserIdentification = updateUserIdentification;
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(currentPass, newPass, newPassConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
/* eslint-disable */
var stripe = Stripe('pk_test_cg8BNalmrvc0LZxFzvdRtviK00dSWpowLx');
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              console.log(form);
              _context3.next = 8;
              return (0, _updateSettings.updateUserIdentification)(form);
...
if (passwordForm) {
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee4(e) {
      var curPass, newPass, newPassConfirm;
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              newPassConfirm = document.getElementById('password-confirm').value;
              _context4.next = 7;
              return (0, _updateSettings.updateUserPassword)(curPass, newPass, newPassConfirm);

            case 7:
              document.querySelector('.btn--save-password').textContent = 'Save password'; // Clear current content
